...
final class CreateUserVips extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $table->addColumn('uid', 'string', ['comment' => 'uid', 'null' => false])
            ...
            ->addColumn('last_vip_at', 'integer', ['comment' => '上次vip开通时间', 'null' => true, 'limit' => MysqlAdapter::INT_BIG])
            ->addColumn('end_vip_at', 'integer', ['comment' => '最终vip开通时间', 'null' => true, 'limit' => MysqlAdapter::INT_BIG])

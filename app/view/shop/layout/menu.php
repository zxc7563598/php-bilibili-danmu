<div id="sidebar" class="column is-one-fifth">
    <aside class="menu" style="padding:1rem;">
        ...
        <ul class="menu-list">
            ...
            <li><a href="/points-mall/shipping-management" class="<?php echo ($currentPage === 'shipping-management') ? 'is-active' : ''; ?>">发货管理</a></li>
            <li><a href="/points-mall/complaint-management" class="<?php echo ($currentPage === 'complaint-management') ? 'is-active' : ''; ?>">投诉管理</a></li>
        </ul>
        <p class="menu-label">其他</p>
        <ul class="menu-list">
            <li><a href="/points-mall/feedback" class="<?php echo ($currentPage === 'feedback') ? 'is-active' : ''; ?>">救命！我有问题</a></li>
